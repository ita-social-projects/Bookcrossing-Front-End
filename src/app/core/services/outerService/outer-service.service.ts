...
import { OuterBook } from '../../models/outerBook';
...
export class OuterServiceService {
  ...
  getBooks(paginationParameters: OuterBookQueryParams){
    return this.pagination.getOuterBookPage<OuterBook>(outerBookUrl+"books",paginationParameters);
  }
  

  getBooksById(bookId:number){
    return this.http.get<OuterBook>("https://localhost:44370/api/OuterBooksSource/book/"+bookId);
  }
