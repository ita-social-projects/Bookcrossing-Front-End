...
export class BookLanguagesComponent implements OnInit {
  ...
  // Get
  public getLanguages(params: CompletePaginationParams): void {
    this.languageService.getLanguagePage(params).subscribe({
      next: (pageData) => {
  ...
  public editLanguage(language: ILanguage): void {
    this.languageService.formLanguage = language;
    this.router.navigate(['admin/language-form']);
  }

  public deleteLanguage(language: ILanguage): void {
